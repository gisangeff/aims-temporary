              ...
              <div class="box-body table-responsive no-padding">
                <table class="table table-hover">
                  ...
                  if (isset($_POST['search'])) {
                    ...
                    $query = "SELECT * FROM coachhistory_info WHERE CONCAT(coach_firstname, coach_middlename, coach_lastname) LIKE '%" . $input_search . "%' AND coachhistory_status='Inactive'";
                  } else {
                    $query = "SELECT * FROM coachhistory_info WHERE coachhistory_status='Inactive' ORDER BY date_resigned";
                  }
                  ...
                  foreach ($rows as $row): ?>
                    <tr>
                      ...
                      <td><?php echo $row['date_coached']; ?></td>

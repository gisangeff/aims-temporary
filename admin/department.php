...
if (isset($_GET['delete'])) {
  $id = $_GET['delete'];
  $get_record = $function->getData('course_info', 'dept_code', $id);

  $query = "UPDATE department SET dept_status='Inactive' WHERE dept_code = ".$id."";
              ...
              <div class="box-body table-responsive no-padding">
                <table class="table table-hover">
                  ...
                  if (isset($_POST['search'])) {
                    ...
                    $query = "SELECT * FROM department WHERE dept_title LIKE '%" . $input_search . "%' AND dept_status='Active'";
                  } else {
                    $query = "SELECT * FROM department WHERE dept_status='Active'";
                  ...
                  foreach ($rows as $row): ?>
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="editDepartment.php?id=<?php echo $row['dept_code']; ?>" class="btn btn-success btn-xs">
                          <i class="fa fa-pencil fa-fw"></i>
                        </a>  
                        <a href="delete.php?delete=<?php echo $row['dept_code']; ?>&amp;url=<?php echo 'department.php'; ?>" class="btn btn-danger btn-xs">

...
if (isset($_GET['delete'])) {
  ...
  $query = "UPDATE coach SET coach_status='Inactive' WHERE coach_id = ".$id."";
              ...
              <div class="box-body table-responsive no-padding">
                <table class="table table-hover">
                  ...
                  if (isset($_POST['input-search'])) {
                    ...
                    $query = "SELECT * FROM coach_info WHERE CONCAT(coach_firstname, coach_middlename, coach_lastname) LIKE '%" . $input_search . "%' AND coach_status='Active'";
                  } else {
                  ...
                  foreach ($rows as $row): ?>
                    <tr>
                      ...
                      <td><?php echo $row['coach_gender']; ?></td>
                      <td><?php echo $row['coach_birthdate']; ?></td>
                      <td><?php echo $row['coach_address']; ?></td>
                      <td class="text-center">
                        <a href="infoCoach.php?id=<?php echo $row['coach_id']; ?>" class="btn btn-info btn-xs">
                          <i class="fa fa-info fa-fw"></i>
                        </a> 
                        <a href="editCoach.php?id=<?php echo $row['coach_id']; ?>" class="btn btn-success btn-xs">
                          <i class="fa fa-pencil fa-fw"></i>
                        </a>  
                        <a href="printCoach.php?id=<?php echo $row['coach_id']; ?>" target="_blank" class="btn btn-warning btn-xs">
                          <i class="fa fa-print fa-fw"></i>
                        </a>   
                        <a href="delete.php?delete=<?php echo $row['coach_id']; ?>&amp;url=<?php echo 'coach.php'; ?>" class="btn btn-danger btn-xs">

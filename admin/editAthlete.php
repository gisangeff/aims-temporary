...
if (isset($_GET['id'])) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE athlete SET athlete_firstname='".$firstname."', athlete_middlename='".$middlename."', athlete_lastname='".$lastname."', athlete_gender='".$gender."', athlete_birthdate='".$birthdate."', athlete_address='".$address."', sport_id=".$sport_id.", course_id=".$course_id.", athlete_yearlevel='".$athlete_yearlevel."', athlete_bloodtype='".$athlete_bloodtype."', athlete_username='".$athlete_username."', athlete_password='".$athlete_password."', athlete_status='".$status."' WHERE athlete_id=".$id."";
          ...
          <div class="col-md-10 col-md-offset-1">
            ...
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-2">
                ...
                <select class="form-control" name="athlete-status" style="width: 100%;">
                  <?php
                  $rows = ["active", "Inactive"];
                  for ($i=0; $i < count($rows); $i++){ ?>
                    <option value="<?php echo $rows[$i]; ?>" <?php if($rows[$i]==$column['athlete_status']) echo 'selected="selected"'; ?>><?php echo $rows[$i]; ?></option>
                  <?php }; ?>
                </select>
              </div>

...
if (isset($_GET['delete'])) {
  ...
  $query = "UPDATE athlete SET athlete_status='Inactive' WHERE athlete_id=".$id."";
                ...
                foreach ($rows as $row): ?>
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="infoAthlete.php?id=<?php echo $row['athlete_id']; ?>" class="btn btn-info btn-xs">
                        <i class="fa fa-info fa-fw"></i>
                      </a> 
                      <a href="editAthlete.php?id=<?php echo $row['athlete_id']; ?>" class="btn btn-success btn-xs">
                        <i class="fa fa-pencil fa-fw"></i>
                      </a>  
                      <a href="printAthlete.php?id=<?php echo $row['athlete_id']; ?>" target="_blank" class="btn btn-warning btn-xs">
                        <i class="fa fa-print fa-fw"></i>
                      </a>   
                      <a href="delete.php?delete=<?php echo $row['athlete_id']; ?>&amp;url=<?php echo 'athlete.php'; ?>" class="btn btn-danger btn-xs">

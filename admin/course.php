...
if (isset($_GET['delete'])) {
  ...
  $query = "UPDATE course SET course_status='Inactive' WHERE course_id = ".$id."";
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        <!-- Sidebar user panel -->
        <? include 'pages/layout/sidebar-userPanel.php'; ?>
                  ...
                  foreach ($rows as $row): ?>
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="infoCourse.php?id=<?php echo $row['course_id']; ?>" class="btn btn-info btn-xs">
                          <i class="fa fa-info fa-fw"></i>
                        </a> 
                        <a href="editCourse.php?id=<?php echo $row['course_id']; ?>" class="btn btn-success btn-xs">
                          <i class="fa fa-pencil fa-fw"></i>
                        </a>  
                        <a href="delete.php?delete=<?php echo $row['course_id']; ?>&amp;url=<? echo 'course.php'; ?>" class="btn btn-danger btn-xs">

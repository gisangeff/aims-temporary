  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Athlete
          <small>Athlete Information</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <form method="post" class="form-horizontal">
              <div class="box box-danger">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title">Athlete Information</h3>
                </div>
                <div class="box-body">
                  <dl class="dl-horizontal">
                   <dt>ID:</dt>
                   <dd><?php echo $row['athlete_id']; ?></dd>
                   <dt>Name:</dt>
                   <dd><?php echo $row['athlete_firstname'] . ' ' . $row['athlete_middlename'] . ' ' . $row['athlete_lastname']; ?></dd>
                   <dt>Gender:</dt>
                   <dd><?php echo $row['athlete_gender']; ?></dd>
                   <dt>Date of Birth:</dt>
                   <dd><?php echo $row['athlete_birthdate']; ?></dd>
                   <dt>Address:</dt>
                   <dd><?php echo $row['athlete_address']; ?></dd>
                   <dt>Sports:</dt>
                   <dd><?php echo $row['sport_title']; ?></dd>
                   <dt>Coach:</dt>
                   <dd><?php echo $row['coach_firstname'] . ' ' . $row['coach_lastname']; ?></dd>
                   <dt>Course:</dt>
                   <dd><?php echo $row['course_title']; ?></dd>
                   <dt>Year Level:</dt>
                   <dd><?php echo $row['athlete_yearlevel']; ?></dd>
                   <dt>Blood Type:</dt>
                   <dd><?php echo $row['athlete_bloodtype']; ?></dd>
                   <dt>Username:</dt>
                   <dd><?php echo $row['athlete_username']; ?></dd>
                   <dt>Password:</dt>
                   <dd><?php echo $row['athlete_password']; ?></dd>
                   <dt>Date Registered:</dt>
                   <dd><?php echo $row['date_added']; ?></dd>
                   <dt>Status:</dt>
                   <dd><?php echo $row['athlete_status']; ?></dd>
                   <dt>Encoded by:</dt>
               ...
               <div class="box-footer">
                 ...
                 <button type="submit" name="submit" class="btn btn-danger pull-right" formaction="printAthlete.php?id=<?php echo $row['athlete_id']; ?>" formtarget="_blank">Print</button>
               </div>
             </div>
             <!-- /.box -->
           </form>

...
if (isset($_GET['id'])) {
  $id = $_GET['id'];
  $row = $function->getData('course_info', 'course_id', $id);
              ...
              <div class="box box-danger">
                ...
                <div class="box-body">
                  <dl class="dl-horizontal">
                   <dt>ID:</dt>
                   <dd><?php echo $row['course_id']; ?></dd>
                   <dt>Course:</dt>
                   <dd><?php echo $row['course_title']; ?></dd>
                   <dt>Description:</dt>
                   <dd><?php echo $row['course_description']; ?></dd>
                   <dt>Department:</dt>
                   <dd><?php echo $row['dept_title']; ?></dd>
                 </dl>
               </div>
               <!-- /.box-body -->
               <div class="box-footer">
                 <button type="button" class="btn btn-default pull-right" onclick="window.history.back();">Back</button>
               </div>
             </div>
             <!-- /.box -->
           </form>
